...
const TextBlock = ({ blok }) => {
  ...
  return (
    <div
      className={`z-10 relative [&>p]:leading-loose [&>h1]:my-6 [&>h3]:my-4 [&>h4]:text-xl [&>ol]:list-decimal [&>ol]:pl-5 [&>ol]:my-5 [&>ul]:mb-8 [&>ul]:list-disc [&>ul]:pl-4 [&>ul>li]:leading-8 text_block ${textAlign(blok.textAlign)} ${maxWidth(blok.maxWidth)} ${blok?.name}`}
