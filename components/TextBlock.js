...
const TextBlock = ({ blok }) => {
  ...
  return (
    <div
      className={`z-10 relative leading-loose [&>h1]:my-6 [&>h2]:text-4xl [&>h3]:text-2xl [&>h4]:text-xl [&>ol]:list-decimal [&>ol]:pl-5 [&>ol]:my-5 text_block ${maxWidth(blok.maxWidth)} ${blok?.name}`}
